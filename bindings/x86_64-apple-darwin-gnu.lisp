;; Generated by :claw at 2021-09-23T18:45:49.653886Z
(uiop:define-package :%chipmunk (:use))
(uiop:define-package :aw-chipmunk-bindings~pristine (:use :cl))
(common-lisp:in-package :aw-chipmunk-bindings~pristine)
...
(cffi:defcenum (%chipmunk::body-type :unsigned-int)
               "/home/borodust/devel/repo/aw-projects/aw-chipmunk/src/lib/chipmunk/include/chipmunk/cpBody.h:28:14"
               (:dynamic 0)
               (:kinematic 1)
               (:static 2))

(cffi:defbitfield (%chipmunk::space-debug-draw-flags :unsigned-int)
                  "/home/borodust/devel/repo/aw-projects/aw-chipmunk/src/lib/chipmunk/include/chipmunk/cpSpace.h:280:14"
                  (:shapes 1)
                  (:constraints 2)
                  (:collision-points 4))
